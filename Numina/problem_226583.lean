...
theorem number_theory_226583 {n : ℕ} :
  ...
  · have hl := Nat.isZeckendorfRep_zeckendorf n
    simp only [List.IsZeckendorfRep, List.chain'_append] at hl
  ...
  · intro l ⟨hl_gap, hl_min, hl_sum⟩
    ...
    exact (Equiv.symm_apply_eq Nat.zeckendorfEquiv).mp hl_sum  -- TODO: wtf?
