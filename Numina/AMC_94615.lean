-- https://cloud.kili-technology.com/label/projects/label/cm7eniew000h5zz87966e5kv6?userID=cm7ln00x0cbs001at7mnncm9v

import Mathlib

/- Let f(x) = a * x^2 + b * x + c where a, b, c are integers.
Suppose that f(1) = 0, 50 < f(7) < 60, 70 < f(8) < 80,
and 5000k < f(100) < 5000(k + 1) for some integer k.
What is k?
(A) 1
(B) 2
(C) 3
